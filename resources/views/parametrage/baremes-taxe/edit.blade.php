<x-app-layout title="Modifier un barème de taxe">

<x-page-header titre="Modifier le barème de taxe" />

<form method="POST" action="{{ route('parametrage.baremes-taxe.update', $baremeTaxe) }}" novalidate>
    @csrf @method('PUT')
        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <select name="nature_taxe_id" class="form-select form-select-lg @error('nature_taxe_id') is-invalid @enderror" required>
                        ...
                        @foreach ($naturesTaxe as $n)
                            <option value="{{ $n->id }}" {{ old('nature_taxe_id', $baremeTaxe->nature_taxe_id) == $n->id ? 'selected' : '' }}>
                ...
                <div class="col-md-4">
                    ...
                    <select name="categorie_activite_id" class="form-select form-select-lg @error('categorie_activite_id') is-invalid @enderror">
                        ...
                        @foreach ($categories as $c)
                            <option value="{{ $c->id }}" {{ old('categorie_activite_id', $baremeTaxe->categorie_activite_id) == $c->id ? 'selected' : '' }}>
                                {{ $c->libelle }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <select name="periodicite_id" class="form-select form-select-lg @error('periodicite_id') is-invalid @enderror" required>
                        ...
                        @foreach ($periodicites as $p)
                            <option value="{{ $p->id }}" {{ old('periodicite_id', $baremeTaxe->periodicite_id) == $p->id ? 'selected' : '' }}>
                                {{ $p->libelle }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="ca_borne_inf" value="{{ old('ca_borne_inf', (int) $baremeTaxe->ca_borne_inf) }}"
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="ca_borne_sup" value="{{ old('ca_borne_sup', (int) $baremeTaxe->ca_borne_sup) }}"
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="taux" value="{{ old('taux', $baremeTaxe->taux) }}"
    ...
    <div class="d-flex justify-content-end gap-2 mb-4">
        <a href="{{ route('parametrage.baremes-taxe.show', $baremeTaxe) }}" class="btn btn-outline-secondary btn-lg">
