...
<div class="row g-3 mb-3">
    <div class="col-lg-5">
        <div class="card h-100 card-section">
            ...
            <div class="card-footer d-flex justify-content-end align-items-center py-2 fs-9 text-600">
                <span class="fas fa-clock me-1"></span>Mis à jour le {{ $service->updated_at?->format('d/m/Y') ?? '—' }}
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-7">
        <div class="card h-100 card-section">
            <div class="card-header py-3"><h5 class="mb-0 d-flex align-items-center"><span class="num-section">02</span><span class="fas fa-users me-2 text-primary"></span>Agents rattachés
            ...
            <div class="card-footer d-flex justify-content-end align-items-center py-2 fs-9 text-600">
                <span class="fas fa-users me-1"></span>{{ $service->agents->count() }} agent(s)
            </div>
        </div>
    </div>
</div>
